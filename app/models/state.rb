class State < ApplicationRecord
  ...
  validates :state_population, numericality: { greater_than_or_equal_to: 100_000,  message: 'الحقل الخاص بـ (التعداد السكاني) يجب الا يكون فارغا  و الا يحتوى الا على ارقام و الا يكون التعداد السكاني اقل من (100,000) نسمة.' }
